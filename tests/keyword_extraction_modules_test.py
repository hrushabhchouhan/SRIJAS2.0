...
def test_main_function():
  assert get_user_id_to_list_of_job_ids(resume_skills_dict, links_description_dict, total_skills, threshold) == {'res1': ['link1']}
...
def test_get_user_id_to_list_of_job_ids():
    assert kem.get_user_id_to_list_of_job_ids(resume_skills_dict, links_description_dict, total_skills, threshold) == {'res1': ['link1']}
