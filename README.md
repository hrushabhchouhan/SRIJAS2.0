...
[![Build Status](https://app.travis-ci.com/hvudeshi/SRIJAS.svg?branch=main)](https://app.travis-ci.com/het-patel99/SRIJAS)
...
<table border="2" bordercolorlight="#b9dcff" bordercolordark="#006fdd">
  ...
  <tr style="background: #010203;"> 
    <td colspan = "2">
      ...
      <a href="./images/emailemail_updated_final.png">
